        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="confirm-email" class="form-horizontal" method="POST" action="{{ route( 'confirm.email', ( !empty( $hash )?$hash:'' ) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label for="email" class="col-md-4 control-label">{{ trans( 'LEC.view.confirm.vcode' ) }}</label>
                            <div class="col-md-6">
                                <input type="text" name="vcode" class="form-control" value="@if( !empty( $hash ) ){{ $hash }}@endif" placeholder="{{ trans( 'LEC.view.confirm.vcode' ) }}" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                <a class="btn btn-link" href="{{ route( 'confirm.repeat' ) }}">{{ trans( 'LEC.view.confirm.resend' ) }}</a>
                            </div>
                        </div>
                    </form>
                </div>
